...
def data_loader(dataset_path, pixel, batch_size):
	...
	train_dataset = torchvision.datasets.CelebA(dataset_path, 'train', 'attr', transforms, download=False)
	test_dataset = torchvision.datasets.CelebA(dataset_path, 'test', 'attr', transforms, download=False)
